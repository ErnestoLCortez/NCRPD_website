            ...
            if( $grid ) {
                ...
                if( $image ) {
                    ...
                    if( !$controls && EasyImageCollage::option( 'pinterest_enable', '0' ) == '1' ) {
                        ...
                        $pin_description = esc_attr( $image_post->post_title );
                        ...
                        $output .= '<a data-pin-do="buttonPin" href="https://www.pinterest.com/pin/create/button/?media=' . $pin_image . '&description=' . $pin_description . '"' . $pin_style . $pin_size . '></a>';
                    }
    ...
    private function draw_block_frontend( $block, $grid )
    {
        if( $block['type'] == 'img' ) {
            ...
            if( $image ) {
                ...
                $output .= '<img src="' . $url . '" style="' . $img_style . '" title="' . esc_attr( $title ) . '" alt="' . esc_attr( $alt ) . '" />';
