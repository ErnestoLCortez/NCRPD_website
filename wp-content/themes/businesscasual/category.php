...
<div id="content">
    <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><?php printf( __( '%s' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></strong>
                    </h2>
                    <hr>
                </div>
	<?php echo '<div class="text-center">'.category_description().'</div>'; /* displays the category's description from the Wordpress admin */ ?>
