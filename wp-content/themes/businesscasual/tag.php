...
<div class="row">
            <div class="box">
                ...
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><?php printf( __( 'Tag : %s' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></strong>
                    </h2>
                    <hr>
                </div>
	<?php echo '<div class="text-center">'.tag_description().'</div>'; /* displays the category's description from the Wordpress admin */ ?>
