                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="<?php bloginfo('template_directory'); ?>/img/slide-1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?php bloginfo('template_directory'); ?>/img/slide-2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?php bloginfo('template_directory'); ?>/img/slide-3.jpg" alt="">
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="img-responsive img-border img-left" src="<?php bloginfo('template_directory'); ?>/img/intro-pic.jpg" alt="">
                    <hr class="visible-xs">
